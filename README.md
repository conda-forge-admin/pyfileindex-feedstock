...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyfileindex-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyfileindex-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyfileindex
# for installing globally
pixi global install pyfileindex
```
...
It is possible to list all of the versions of `pyfileindex` available on your platform:
...
```
pixi search pyfileindex --channel conda-forge
```
